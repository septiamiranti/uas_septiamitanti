...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('hari.index') }}" class="nav-link">Hari</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('jurusan.index') }}" class="nav-link">Jurusan</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('kurikulum.index') }}" class="nav-link">Kurikulum</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('pelajaran.index') }}" class="nav-link">Pelajaran</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('perkiraan.index') }}" class="nav-link">Perkiraan</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
